...
fprintf(id, "С самолета выброшен предмет сечением %f3.1 $\\text{м}^2$ и массой %f3.1 кг с начальной нулевой вертикальной скоростью. Численно решить дифференциальное уравнение изменения скорости от времени, при условии, что сила сопротивления воздуха пропорциональна квадрату скорости и площади сечения предмета $f = k S \\upsilon^2$, где k = %f5.4 --- коэффициент пропорциональности. Построить график изменения скорости от времени. Определить скорость предмета через %f3.0 секунд.", S, m, k, t)
endif
...
fprintf(id, "Тело брошено под углом %3.0 градусов к поверхности земли. Не учитывая сопротивления воздуха решить дифференциальное уравнение движения. Построить траекторию движения тела. Определить через какое время тело будет на высоте %3.0 м", u, h)
endif
...
fprintf(id, "Тело брошено под углом %3.0 градусов к поверхности земли. Не учитывая сопротивления воздуха решить дифференциальное уравнение движения. Построить траекторию движения тела. Определить через какое время тело упадет на землю.", u)
endif
...
fprintf(id, "Тело брошено под углом %3.0 градусов к поверхности земли. Не учитывая сопротивления воздуха решить дифференциальное уравнение движения. Построить траекторию движения тела. Определить какое расстояние пролетит тело.", u)
endif
